...
('JA501', 'Sempati Star', 'PEKANBARU', 'MEDAN'),
('EM909', 'P.T.A.L.S', 'DUMAI', 'DURI'),
('AI504', 'PUTRA PELANGI', 'MEDAN', 'PEKANBARU'),
('AI873', 'MEDAN JAYA', 'SIBORORNG BORONG', 'MEDAN'),
('EM547', 'MAKMUR', 'PERAWANG', 'DURI');
